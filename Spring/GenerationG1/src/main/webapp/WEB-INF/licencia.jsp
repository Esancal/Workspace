            ...
            <body>
                <div class="container">
                    ...
                    <form:form action="/licencia/guardar" method="post" modelAttribute="licencia">
                        ...
                        <form:input path="fechaVencimiento" type="date" min="2018-01-01" max="2030-01-01"
                            class="form-control" />
                        <br>
                        ...
                        <form:select path="usuario" class="form-select">
                            ...
                            <c:forEach var="usuario" items="${listaUsuarios}">
                                <c:if test="${usuario.licencia.id == null}"> 
                                    <form:option value="${usuario.id}">${usuario.nombre} ${usuario.apellido}
                                        <!-- Aqui con value recibimos la PK desde el path "usuario" -->
                                    </form:option>
                                </c:if>
                            </c:forEach>
                        </form:select>
